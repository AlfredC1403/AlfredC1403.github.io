(()=>{var e,t;-1<navigator.platform.indexOf("Win")&&(document.getElementsByClassName("main-content")[0]&&(e=document.querySelector(".main-content"),new PerfectScrollbar(e)),document.getElementsByClassName("sidenav")[0]&&(e=document.querySelector(".sidenav"),new PerfectScrollbar(e)),document.getElementsByClassName("navbar-collapse")[0]&&(t=document.querySelector(".navbar:not(.navbar-expand-lg) .navbar-collapse"),new PerfectScrollbar(t)),document.getElementsByClassName("fixed-plugin")[0])&&(t=document.querySelector(".fixed-plugin"),new PerfectScrollbar(t))})(),document.getElementById("navbarBlur")&&navbarBlurOnScroll("navbarBlur");var allInputs,fixedPlugin,fixedPluginButton,fixedPluginButtonNav,fixedPluginCard,fixedPluginCloseButton,navbar,buttonNavbarFixed,tooltipTriggerList=[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')),tooltipList=tooltipTriggerList.map(function(e){return new bootstrap.Tooltip(e)});function focused(e){e.parentElement.classList.contains("input-group")&&e.parentElement.classList.add("focused")}function defocused(e){e.parentElement.classList.contains("input-group")&&e.parentElement.classList.remove("focused")}function setAttributes(t,s){Object.keys(s).forEach(function(e){t.setAttribute(e,s[e])})}function sidebarColor(a){var color=a.getAttribute("data-color"),gradientClasses=["bg-gradient-primary","bg-gradient-dark","bg-gradient-info","bg-gradient-success","bg-gradient-warning","bg-gradient-danger"],colorMapping={primary:"#D81B60",dark:"#191919",info:"#1A73E8",success:"#43A047",warning:"#FFA726",danger:"#E53935"};var navLink=document.querySelector(".nav-link.active");gradientClasses.forEach(cls=>navLink.classList.remove(cls)),navLink.classList.add("bg-gradient-"+color);var navButton=document.querySelector(".btn");gradientClasses.forEach(cls=>navButton.classList.remove(cls)),navButton.classList.add("bg-gradient-"+color);if(window.dailySalesChart){const newColor=colorMapping[color]||"#43A047";window.dailySalesChart.data.datasets[0].backgroundColor=newColor,window.dailySalesChart.update()}if(window.anualSalesChart){const newColor=colorMapping[color]||"#43A047";window.anualSalesChart.data.datasets[0].borderColor=newColor,window.anualSalesChart.data.datasets[0].pointBackgroundColor=newColor,window.anualSalesChart.update()}}
